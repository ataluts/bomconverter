...
Также программа конвертирует файлы для автоматических установщиков компонентов, добавляя в них информацию о компонентах в нужном формате, транслируя по словарю имена, углы поворота и смещение посадочных мест в соответствии с базой данных установщика и удаляя/отключая компоненты не предназначенные для установки.
