...
**Предупреждение!** Для возможности импорта списка компонентов пришлось немного изменить в нём заголовки таблиц (сделать их уникальными для распознования по имени). Из-за этого списки экспортированные до версии _2025-06-17_ не будут нормально импортироваться с настройками по-умолчанию. Наиболее простое решение - просто заменить их вручную на актуальные перед сравнением.
